/*
 * testdict.c
 * Tests for dict_new_sized() and the dictionary module.
 *
...
int main(void)
{
    ...
    if (d256) {
        ...
        CHECK(dict_count(d256) == 200, "dict_count == 200 after 200 inserts");
